...
$(document).ready(function() {
      $('a[href^="https://www.youtube.com"]').on('click', function(event) {
        ...
        var videoID = $(this).attr('href').replace('https://www.youtube.com/watch?v=', ''),
            videoURL = 'https://www.youtube.com/embed/' + videoID +'?rel=1&autoplay=1&enablejsapi=1';
...
$(document).ready(function () {
    $('#subscribe-form').on('submit', function(e) {
        e.preventDefault();
        setTimeout(function(){ $(".success-box").addClass("hidden"); }, 2200);
    });
});