...
function getUserTransaction() {
    ...
    var URL = 'https://api-frankinmutualfund.azurewebsites.net/api/profile/transactions'
    ...
    function viewUserTransactions(id) {
        ...
        $('#transactionDetails').modal('show');
         ...
         var TransactionSingleUserURL = 'https://api-frankinmutualfund.azurewebsites.net/api/profile/transactions';
