...
function getKYCProfile() {
	...
	var KYCProfileURL = 'https://api-verifykyc.azurewebsites.net/api/kyc/profile/all?status=pending';
                    ...
                    var t = $("#user_kyc_data").mDatatable({
                        ...
                        },
						{
                            ...
                            template: function(t, e, a) {
                                ...
                                var btnhtml = '\t\t\t\t\t\t<div class="dropdown ' + (a.getPageSize() - e <= 4 ? "dropup" : "") + '">\t\t\t\t\t\t\t<a href="javscript:;" onclick="viewUserDetails(' + id + ')" class="bg-white btn btn-sm btn-outline-light btn-icon btn-tooltip" title="View More Details" data-original-title="View Details"><em class="icon ni ni-eye"></em></a>\t\t\t\t\t<a href="javscript:;" onclick="approveRequest(' + kycId + ')" class="bg-white btn btn-sm btn-outline-light btn-icon btn-tooltip" title="Approve Request" data-original-title="Approve Request"><em class="icon ni ni-done"></em></a>\t\t\t\t\t<a href="javscript:;" onclick="rejectRequest(' + kycId + ')" class="bg-white btn btn-sm btn-outline-light btn-icon btn-tooltip" title="Reject Request" data-original-title="Reject Request"><em class="icon ni ni-cross-round"></em></a>\t\t\t\t\t';
    ...
    function approveRequest(id) {
        ...
        console.log('KYC ID to Approve :', id);


        var approveKYCURL = 'https://api-verifykyc.azurewebsites.net/api/kyc/status/user/'+id;

        var data = {
              "status": "verified",
              "comments": "All Documents looks fine. hence Approved",
              "updatedAt": new Date(),
              "approvedAt": new Date()
        }
         ...
         console.log('String of data :', JSON.stringify(data));
                    ...
                    $.ajax({
                        ...
                        success: function(result, textStatus, xhr) {
                            ...
                            toastr.success('Request approved successfully', 'KYC Request Approved');
    ...
    function rejectRequest(id) {
        ...
        console.log('KYC ID to Reject :', id);

        var approveKYCURL = 'https://api-verifykyc.azurewebsites.net/api/kyc/status/user/'+id;

        var data = {
              "status": "rejected",
              "comments": "Your Uploaded documents has issue. Please check and resubmit again.",
              "updatedAt": new Date()
        }
        ...
        console.log('String of data :', JSON.stringify(data));
                    ...
                    $.ajax({
                        ...
                        success: function(result, textStatus, xhr) {
                            ...
                            toastr.success('Request rejected successfully', 'KYC Request Rejected');
