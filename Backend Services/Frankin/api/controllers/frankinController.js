...
exports.welcome = function (req, res) {
  ...
  res.status(200).send({
    message:
      "This service is built for Microsoft Hackathon by Team Tashiqa. Please visit 'https://api-frankinmutualfund.azurewebsites.net/api/swagger/api-docs' for viewing swagger definition of this service.",
  });
};
...
exports.ping = function (req, res) {
  //This function can be called by anyone
  res.status(200).send({
    message: "Frankin service is up and running.",
  });
};
